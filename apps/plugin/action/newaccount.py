...
def execute(pagename, request):
    ...
    #Begin change from GunnarScherf
    groups = request.groups
    account_groups = set(groups.groups_with_member(request.user.name))
    if not "AdminGruppe" in account_groups:
